...
export const metadata: Metadata = {
  ...
  description:
    "How Tero handles your data, our use of cookies and Google Analytics with consent, and our independence from the University of the Philippines.",
};

function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="rounded-clay-lg border border-clay-line bg-cream p-7 shadow-clay">
  ...
  return (
    <div className="mx-auto max-w-content px-5 py-14 lg:py-20">
      ...
      <p className="mt-3 text-base text-ink-muted">
        Last updated: 2026. This page explains who Tero is, how we handle your information, and the
        limits of what the mock exam means.
      </p>
      ...
      <div className="mt-8 space-y-6">
        <Section title="Independence from the University of the Philippines">
          <p>
            Tero is an independent UPCAT preparation tool. We are not affiliated with, endorsed by,
            or partnered with the University of the Philippines or the UP Office of Admissions. UPCAT
            is the admission test administered by UP; we reference it only to describe what Tero
            helps you prepare for. We do not use UP&rsquo;s name, seal, logo, or official marks to
            imply any connection.
          </p>
        </Section>

        <Section title="Your mock exam is study guidance, not a prediction">
          <p>
            The mock exam gives a readiness signal based only on the answers you provide. It is not
            an admissions prediction and does not estimate your chances of being admitted anywhere.
            All questions are original practice questions written for Tero. Use your results as a
        ...
        <Section title="What we store and where">
          ...
          <p>
            ...
            submit the mock exam we may save an anonymous attempt (your answers, timing, and scores,
            tied to the anonymous browser ID, not your name). If you join the waitlist, we store the
            email and optional details you give us so we can contact you about Tero.
          </p>
        </Section>

        <Section title="Cookies and Google Analytics (with your consent)">
          <p>
            We use Google Analytics 4 to understand, in aggregate, how students use Tero (for
            example, how many people start and finish the mock exam). Google Analytics is provided by
        ...
        <Section title="Your choices">
          <ul className="list-disc space-y-1.5 pl-5">
            <li>Decline analytics cookies and still use every part of Tero.</li>
